...
class BitacoraModel extends Query
{
    ...
    {
        $sql = "SELECT b.FECHA, u.USUARIO, o.OBJETOS, b.ACCION, b.DESCRIPCION, b.TIPO FROM bitacora b JOIN objetos o ON b.ID_OBJETO = o.ID_OBJETOS JOIN usuarios u ON u.id = b.ID_USUARIO WHERE TIPO != $tipo";
